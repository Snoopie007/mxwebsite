...
function TimeField(props: AriaTimeFieldProps<TimeValue>) {
    ...
    return (
        <div
            ...
            ref={ref}
            className={cn(
                'inline-flex h-10  w-full flex-1 rounded-sm border min-w-[100px] bg-background px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
                props.isDisabled && 'cursor-not-allowed opacity-50',
            )}
        >
            {state.segments.map((segment, i) => (
    ...
    return (
        <div
            ...
            className={cn(
                ...
                'flex items-center  rounded-sm border border-gray-200 ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2',
            )}
        >
            <Popover open={props.isOpen} onOpenChange={props.onOpenChange}>
                ...
                <PopoverContent ref={contentRef} className="w-full">
                    <div {...dialogProps} className="space-y-3">
                        ...
                        {state.hasTime && <TimeField value={state.timeValue} onChange={(value) => { state.setTimeValue(value!) }} />}
                    </div>
                </PopoverContent>
            </Popover>
