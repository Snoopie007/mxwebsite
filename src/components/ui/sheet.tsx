...
const SheetHeader = ({
	...
	<div
		className={cn(
			"flex flex-col px-4 py-2 border-b text-center sm:text-left",
			className
		)}
		{...props}
	/>
...
const SheetFooter = ({
	...
	<div
		className={cn(
			"flex flex-col-reverse bg-background absolute w-full bottom-0 left-0 sm:flex-row sm:justify-end sm:space-x-2",
			className
		)}
		{...props}
	/>
